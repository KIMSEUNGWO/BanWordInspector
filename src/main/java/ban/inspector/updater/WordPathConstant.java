...
public abstract class WordPathConstant {
    ...
    public static final String BAN_WORD_PATH = "src/main/resources/static/BanWords.json";
    public static final String EXCEPT_WORD_PATH = "src/main/resources/static/ExceptWords.json";
